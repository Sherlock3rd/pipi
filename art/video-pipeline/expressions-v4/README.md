...
## 2026-09-20 外部返片
52—98全部47段已返回，原件及SHA256保存在returned/，实际帧数/原生24fps以returned/sources.json为准。运行时已实现全套地面睡姿、屏边扶墙及短反应接入；验证与缺片记录见../../../docs/expressions-v4-runtime.md。原输入包的预估时长不覆盖实际返片。
